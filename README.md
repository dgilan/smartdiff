...
```bash
curl -o- https://raw.githubusercontent.com/dgilan/smartdiff/v0.1.1/install.sh | bash
```

```bash
wget -qO- https://raw.githubusercontent.com/dgilan/smartdiff/v0.1.1/install.sh | bash
```
